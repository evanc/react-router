v0.14.0 - Thu, 2 May 2019 23:23:23 GMT
---------------------------------------

- Use prop-types npm package for proptypes

v0.13.6 - Mon, 18 Jul 2016 19:57:19 GMT
---------------------------------------

- [#3607](../../pull/3607) [added] Support for React v0.15
- [#3645](../../pull/3645) [fixed] Passing through extra props to `<Link>`
